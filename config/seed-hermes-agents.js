...
const agents = [
  {
    ...
    model: 'gpt-5.5',
    instructions: [
      'You are the Financial Documents Analyst for Anduril Industries, a specialist subagent of Hermes.',
  ...
  },
  {
    ...
    model: 'gpt-5.5',
    instructions: [
      'You are the Programs & Contracts Analyst for Anduril Industries, a specialist subagent of Hermes.',
